...
from internnav_baselines.basemodels.diffusion_policy_modified.transformer_for_diffusion_modified import (
    TransformerForDiffusion,
)

# from ...encoder import (
from internnav_baselines.modules.encoder import (
    DistanceNetwork,
    ImageEncoder,
